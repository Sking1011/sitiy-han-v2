...
- [ ] Интерфейс "Создать партию" (выбор рецепта). `(3h)`
- [ ] **Строгое списание:** Блокировка редактирования ингредиентов для Оператора. `(2h)`
- [ ] Логика транзакции (Списание по норме -> Начисление продукции). `(4h)`
- [ ] Журнал производства. `(2h)`
