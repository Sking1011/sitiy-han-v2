...
**Sytyi Han** — ERP-система для учета производства копченых деликатесов в Казахстане. Язык интерфейса — русский, валюта — KZT. Mobile-first (80% использования с телефона). Цель — заменить Excel удобным веб-приложением.
